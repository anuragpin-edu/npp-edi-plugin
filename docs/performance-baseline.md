...
This baseline was generated on an Apple Silicon machine (arm64, .NET 8 Release build) during Phase 3 stabilization. It measures the performance characteristics of parsing large EDI payloads with and without semantic enrichment dictionaries.
...
## Observations
- **Core Parsing (Regex-Free) is extremely fast.** Tokenizing 10k–30k segments takes only 20–40 milliseconds, proving the zero-allocation approach is effective.
